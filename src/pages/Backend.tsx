...
import { Server, Database, Shield, Cloud, Play, Clock, Users, Star, CheckCircle } from 'lucide-react';

const Backend = () => {
  const levels = [
    {
      title: "Dasar (Beginner)",
      description: "Mulai dari fundamental backend development",
      duration: "8 weeks",
      courses: 4,
    ...
    },
    {
      ...
      description: "Pelajari konsep dan tools yang lebih advanced",
      duration: "10 weeks",
      courses: 5,
    ...
    },
    {
      ...
      description: "Master level backend development",
      duration: "12 weeks",
      courses: 6,
  ...
  const roadmapItems = [
    {
      ...
      description: "Pelajari dasar-dasar server dan HTTP protocol",
      icon: Server,
      completed: true
    },
    {
      title: "Database Management",
      description: "SQL dan NoSQL database design dan optimization",
      icon: Database,
      completed: true
    },
    {
      title: "API Development",
      description: "RESTful API dan GraphQL development",
      icon: Cloud,
      completed: false
    },
    {
      title: "Security & Authentication",
      description: "Implementasi keamanan dan sistem autentikasi",
      icon: Shield,
      completed: false
    }
  ];
  ...
  return (
    <div className="min-h-screen pt-16">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-purple-50 via-pink-50 to-red-50 py-20 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-purple-100 text-purple-700 rounded-full text-sm font-semibold">
                ...
                <span>Backend Development Track</span>
              </div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Pelajari cara membangun server-side applications yang robust, scalable, 
                dan secure. Dari dasar hingga arsitektur enterprise-level.
              </p>
              <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                  <Clock className="h-4 w-4 text-purple-600" />
                  <span>30 weeks total</span>
                </div>
                <div className="flex items-center space-x-2">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-8">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Backend Development Preview
                </h3>
                <p className="text-gray-600 mb-4">
                  Lihat overview lengkap tentang backend development dan teknologi yang akan dipelajari
                </p>
                <button className="w-full px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:shadow-lg transition-all duration-200">
                  Watch Preview
                </button>
              </div>
            </div>
              ...
              {roadmapItems.map((item, index) => {
                ...
                return (
                  <div key={index} className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                    ...
                    <div className="relative z-10 flex items-center justify-center w-8 h-8 bg-white border-4 border-purple-500 rounded-full"></div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Siap Memulai Journey Backend Development?
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Bergabung dengan ribuan developer yang sudah memulai karier mereka di backend development
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-3 bg-white text-purple-600 font-semibold rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-200">
              Mulai Sekarang
            </button>
